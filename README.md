...
### FULL STACK + ML Engineer | CS (AI) & Business Information Systems 
...
<img src="https://github-readme-stats.vercel.app/api?username=eahishak&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0D1117&title_color=03cb87&icon_color=667eea&text_color=c9d1d9&count_private=true&include_all_commits=true" alt="GitHub Stats" width="49%" />
<img src="https://github-readme-streak-stats.herokuapp.com/?user=eahishak&theme=tokyonight&hide_border=true&background=0D1117&stroke=667eea&ring=03cb87&fire=f093fb&currStreakLabel=03cb87" alt="GitHub Streak" width="49%" />

<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=eahishak&layout=compact&theme=tokyonight&hide_border=true&bg_color=0D1117&title_color=03cb87&text_color=c9d1d9&langs_count=8&hide=html,css" alt="Top Languages" width="49%" />
<img src="https://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=eahishak&theme=tokyonight&utcOffset=-5" alt="Productive Time" width="49%" />
...
<img src="https://img.shields.io/badge/Total_Commits-131-03cb87?style=for-the-badge&labelColor=1a1b27" />
</td>
<td align="center" width="25%">
<img src="https://img.shields.io/badge/Pull_Requests-1-667eea?style=for-the-badge&labelColor=1a1b27" />
</td>
<td align="center" width="25%">
<img src="https://img.shields.io/badge/Issues_Resolved-130-f093fb?style=for-the-badge&labelColor=1a1b27" />
</td>
<td align="center" width="25%">
<img src="https://img.shields.io/badge/Repos-2-03cb87?style=for-the-badge&labelColor=1a1b27" />
</td>
</tr>
</table>
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=eahishak&theme=tokyo-night&hide_border=true&bg_color=0D1117&color=03cb87&line=667eea&point=f093fb&area=true&area_color=03cb87" alt="Contribution Graph" width="98%" />
...
<details open>
<summary><b>MemVerge — Open-Source AI Engineering Intern</b></summary>
...
**What I'm working on:**
- Building cache synchronization layers to improve token retrieval across distributed systems
- Creating benchmarking tools to measure token recall efficiency
- Fixing bugs and addressing GitHub issues related to caching and model alignment
- Helping improve AWS deployment workflows through automation scripts

**Technologies:** Python, AWS, Docker, PyTorch, Redis, Kubernetes

**Impact so far:**
- Resolved 12+ GitHub issues related to system stability
...
<details>
<summary><b>Foundly — Software Engineer (Side Project)</b></summary>
...
**What I built:**
- React frontend with real-time updates using Supabase
- Node.js backend with RESTful APIs for item management
- Firebase authentication with Google OAuth for university accounts
- Basic TensorFlow model to suggest potential matches based on item descriptions
- Google Maps integration for location-based searching

**Technologies:** React, Node.js, Firebase, Supabase, TensorFlow, Google Maps API

**Results:**
- Currently being tested with campus security office
...
<details>
<summary><b>Cendance Systems — Salesforce Engineering Intern</b></summary>
...
**What I worked on:**
- Created a forecasting dashboard using React that pulled data from Salesforce API
- Built Python scripts to automate data cleaning and preparation
- Integrated HubSpot and Stripe APIs for centralized data views
- Deployed services to AWS EC2 and set up basic monitoring

**Technologies:** Python, React, AWS, Salesforce API, Docker

**What I learned:**
- How to work with enterprise APIs and handle authentication flows
...
<details>
<summary><b>Jackal Tech — Founder & Developer</b></summary>
...
**Projects built:**
- **Health appointment system:** Scheduling platform for a local clinic (serving ~200 patients)
- **Education platform:** Course management tool used by 3 high schools (~1,500 students)
- **Community app:** Event notification system for local community organization

**Technologies:** React, Next.js, Node.js, PostgreSQL, Firebase, MongoDB

**What I learned:**
- End-to-end product development from idea to deployment
- Working directly with users to understand their needs
...
<details>
<summary><b>Headstarter AI — Software Engineering Fellow</b></summary>
...
**What I built:**
- Authentication system supporting OAuth, magic links, and email/password
- Real-time chat feature using WebSockets and React
- Helped optimize deployment process using Docker and AWS

**Technologies:** Python, React, TypeScript, WebSocket, Docker, AWS

**Key takeaway:**
- Learned best practices for authentication and real-time features
- Got hands-on experience with deployment and DevOps workflows
...
**Features:**
- Job matching algorithm using TensorFlow
- User dashboards for both recruiters and candidates
...
### Handler Premier Scholar

<img src="https://img.shields.io/badge/Recognition-Top_1%25-03cb87?style=for-the-badge&labelColor=1a1b27" />

**University of Rochester**

Awarded to students demonstrating academic excellence and leadership potential within the university community.
...
<img src="https://img.shields.io/badge/Ranking-Top_6-667eea?style=for-the-badge&labelColor=1a1b27" />

**ITU 2022**

Placed in top 6 out of 500+ teams in international technology competition focused on social impact projects.
...
<img src="https://img.shields.io/badge/Carnegie_Mellon-CS_Academy-f093fb?style=for-the-badge&labelColor=1a1b27" />

Completed advanced coursework in Python programming and computer science fundamentals.
...
<img src="https://img.shields.io/badge/Google-Professional-03cb87?style=for-the-badge&labelColor=1a1b27" />

Professional certificate in data analysis, visualization, and business intelligence.
...
I help organize tech workshops and coding sessions for students interested in software development. We typically have around 20-30 students at our events, and I've led sessions on React, cloud deployment, and interview prep.
...
const currentStatus = {
    ...
    seeking: "Summer 2025 SWE Internships",
    working_on: [
        "MemVerge open-source contributions",
        "Building Foundly lost-and-found platform",
